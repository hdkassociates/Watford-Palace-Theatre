								...
								<div class="gridblock bookingtitle">
									<div class="inside" style="<?php echo $featured?'background-image:url(\''.$featured.'\');':''; ?>">
										<div class="blocktextcentered">
											<div class="centerbox">
											My <strong>Basket</strong>
											</div>
										</div>
									</div>
								</div>
								<div class="gridblock spektrixiframe">
									<iframe name="SpektrixIFrame" id="SpektrixIFrame" frameborder="0" src="<?php echo $Spektrix->basket_link; ?>" style="width:100%; height:2000px;" language="javascript" onload="setTimeout(function(){ window.scrollTo(0,0);}, 100)"></iframe>	
								</div>
							</div>
							<?php
